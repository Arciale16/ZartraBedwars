#!/usr/bin/env python3
"""Run every deterministic M08.1 governance and API validation gate."""
...
from m08_1_architecture import validate as validate_m08_1_architecture
...
def main() -> int:
    """Run the full M00-M08.1 deterministic validation chain."""
    failures: list[str] = []
    if platform.python_version() != "3.12.13":
        failures.append(f"Python runtime must be 3.12.13, found {platform.python_version()}")
    for validator in (
        validate_all, validate_m02_architecture, validate_m03_architecture,
        validate_m04_architecture, validate_m05_architecture,
        validate_m06_m22_allocation, validate_m06_architecture,
        validate_m07_m09_allocation, validate_m07_architecture,
        validate_m08_m09_allocation, validate_m08_architecture,
        validate_m08_1_architecture,
    ):
    ...
    commands = [
        ...
        ("M08.1 binary/API compatibility", [
            sys.executable, "tools/validation/api_compatibility_m08_1.py", "check",
        ]),
        ("M08.1 strict JavaDoc", [
            sys.executable, "tools/validation/api_docs_m08_1.py",
        ]),
        ("addon catalogue", [
    ...
    if failures:
        ...
        return 1
    print("Milestone M08.1 deterministic validation PASS.")
    return 0
