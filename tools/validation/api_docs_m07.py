#!/usr/bin/env python3
"""Generate strict deterministic M07 JavaDoc archives including zbw-arena."""
...
NEUTRAL_MODULES = api_docs.NEUTRAL_MODULES + ("arena/zbw-arena",)
NEUTRAL_OUTPUT = ROOT / "target/apidocs-m07-neutral"
MODERN_OUTPUT = ROOT / "target/apidocs-m07-modern"
NEUTRAL_ARCHIVE = ROOT / "target/zartrabedwars-m07-neutral-javadoc.zip"
MODERN_ARCHIVE = ROOT / "target/zartrabedwars-m07-modern-javadoc.zip"
...
def main() -> int:
    ...
    print(
        f"M07 JavaDoc PASS: {len(neutral_sources)} Java 8 and "
