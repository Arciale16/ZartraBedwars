#!/usr/bin/env python3
"""Run deterministic M10 governance, inventory, API and documentation gates."""
...
from m10_allocation import validate as validate_allocation
from m10_architecture import validate as validate_architecture
...
def main() -> int:
    ...
    failures.extend(validate_allocation())
    ...
    if failures:
        return 1
    print("Milestone 10 deterministic validation PASS.")
    return 0
