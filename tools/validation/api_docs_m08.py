#!/usr/bin/env python3
"""Generate strict deterministic M08 JavaDoc archives including zbw-game."""
...
NEUTRAL_OUTPUT = ROOT / "target/apidocs-m08-neutral"
MODERN_OUTPUT = ROOT / "target/apidocs-m08-modern"
NEUTRAL_ARCHIVE = ROOT / "target/zartrabedwars-m08-neutral-javadoc.zip"
MODERN_ARCHIVE = ROOT / "target/zartrabedwars-m08-modern-javadoc.zip"
...
def main() -> int:
    ...
    print(
        f"M08 JavaDoc PASS: {len(neutral_sources)} Java 8 and "
