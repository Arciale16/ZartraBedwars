#!/usr/bin/env python3
"""Run every deterministic Milestone 6 governance and API validation gate."""
...
def main() -> int:
    """Run the full M00-M06 validation chain."""
    failures: list[str] = []
    ...
    if failures:
        ...
        return 1
    print("Milestone 6 deterministic validation PASS.")
    return 0
