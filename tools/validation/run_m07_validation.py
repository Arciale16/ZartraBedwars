#!/usr/bin/env python3
"""Run every deterministic Milestone 7 governance and API validation gate."""
...
def main() -> int:
    """Run the full M00-M07 validation chain."""
    failures: list[str] = []
    ...
    commands = [
        ...
        ("M07 strict JavaDoc", [sys.executable, "tools/validation/api_docs_m07.py"]),
        ("addon catalogue", [
    ...
    if failures:
        ...
        return 1
    print("Milestone 7 deterministic validation PASS.")
    return 0
