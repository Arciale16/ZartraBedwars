#!/usr/bin/env python3
"""Run every deterministic Milestone 2 governance and API validation gate."""
...
def main() -> int:
    ...
    commands = [
        ...
        ("M1 and M2 dependency/licence/SBOM", [sys.executable, "tools/dependencies/lock_dependencies.py", "validate"]),
    ...
    if failures:
        ...
        return 1
    print("Milestone 2 deterministic validation PASS.")
    return 0
