...
ATLAS_MODULES = ("atlas/zbw-atlas-api", "atlas/zbw-atlas", "atlas/zbw-atlas-sql")
ATLAS_CLASSPATH_MODULES = ("api/zbw-api", "replay/zbw-replay-api", "atlas/zbw-atlas-api", "atlas/zbw-atlas")
