...
| ZBW-INT-009 | M21 Phase 1 Java 8 native party aggregate and SQL authority; AlessioDP adapter remains a later M21 provider | parties/integrations | party + admin / party.* later | party/admin later | `PartyProvider`, immutable party snapshots/intents | party fields later | lifecycle/privacy/expiry/migration/provider/SQL recovery tests | `PARTY_M21_PHASE1.md`; M20 transport / M21 Phase 1 foundation |
