...
| ZBW-INT-005 | M06 WorldProvider SPI/native primary adapter; M21 Phase 1 governance explicitly retains optional WorldEdit/FAWE/WorldGuard/Slime/Multiverse adapters and intermediate migration for later M21 phases | integrations/world | provider migrate/status / world.* later | world/integration manager later | WorldProvider SPI | provider status | native primary CT/E2E M06; provider CT/MT M21 | provider guides; M06 foundation/M21 allocation confirmed; no Phase 1 vendor implementation |
