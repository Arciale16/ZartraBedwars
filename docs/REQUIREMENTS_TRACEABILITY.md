...
| Requirement | Planned implementation and data/migration | Configuration | Cmd / permission | GUI | API / events | PH | Tests | Documentation / milestone |
|---|---|---|---|---|---|---|---|---|
| ZBW-GAME-001 | M08 VERIFIED: Java-8 match/session/team state machine and use cases; closed event/effect translation in `zbw-paper-modern` | modes/arenas/performance | M09 join/start/forcestart adapters / play,force; M08 use cases enforce authorization | M09 waiting/admin arena surfaces | M08 Game/Arena APIs + lifecycle events | M16 arena state/countdown | M08 state/property/primary-Paper E2E PASS; M09 surface E2E | `IMPLEMENTATION_M08.md`; M08 core/primary Paper VERIFIED / M09 presentation |
| ZBW-GAME-002 | M08 VERIFIED: elimination/generic phase policies and primary Paper event translation; mode-specific policy remains M10 | modes/events/items | M09 game-event controls / force | M09/M10 spectator/admin presentation | M08 combat/phase events | M16 bed/team/time state | M08 core/primary E2E PASS; M10 gameplay matrix; M09 surface E2E | `GAME_ENGINE_M08.md`; M08 core VERIFIED / M09 presentation / M10 modes |
