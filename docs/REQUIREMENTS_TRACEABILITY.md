...
| ZBW-GAME-004 | M08.1 VERIFIED foundational representation of standard/custom team layouts and overrideable neutral victory contract; mode definitions/strategies remain M10 | `modes.yml`; arena definitions carry limits/teams | mode select/manage / use,manage | mode selector/editor | M08.1 neutral team/victory contracts; Mode API/events M10 | mode + mode stats | M08.1 layout matrix; all-mode E2E M10 | `LAYOUT_COMPATIBILITY_M08_1.md`; M08.1 foundation / M10 completion |
