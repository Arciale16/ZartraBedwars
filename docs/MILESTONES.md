...
- **Phase 4 certification status:** COMPLETE for the materialized nine-provider, native/external party, dual-anticheat and CloudNet lifecycle scope. Plugin Doctor reports PRESENT/ABSENT/INCOMPATIBLE/DUPLICATE; failure/race/restart/drain tests and the operations runbook pass. Formal M21 completion remains blocked by the explicitly retained ZBW-INT-005 optional world-provider adapters; milestone state therefore remains active and M22 is not started.
