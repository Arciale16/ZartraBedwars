...
/** Velocity-facing lifecycle and plugin-message boundary with no domain ownership. */
public final class VelocityProxyAdapter {
    ...
    public VelocityProxyAdapter(final ProxyAdapterRuntime runtime, final ProxyTransport transport) {
