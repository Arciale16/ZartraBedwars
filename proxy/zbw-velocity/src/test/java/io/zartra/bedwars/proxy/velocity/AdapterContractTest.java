package io.zartra.bedwars.proxy.velocity;

import io.zartra.bedwars.proxy.velocity.VelocityProxyAdapter;
...
class AdapterContractTest {
    @Test void lifecycleMessagingAndAuthenticationAreEquivalent() {
        ...
        VelocityProxyAdapter adapter = new VelocityProxyAdapter(runtime, (backend, message) -> CompletableFuture.completedFuture(null));
