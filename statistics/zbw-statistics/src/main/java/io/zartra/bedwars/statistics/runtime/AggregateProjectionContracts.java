...
public final class AggregateProjectionContracts {
    ...
    /** Validates deterministic season rollover boundaries. */ public interface SeasonBoundary { /** @return true when timestamp belongs to this season */ boolean contains(Instant timestamp); /** @return canonical season identity */ NamespacedIdentifier seasonId(); }
