...
public final class PlayerStatistic {
    private final PlayerId playerId; private final StatisticId statisticId; private final StatisticScope scope;
    private final long value; private final RecordRevision revision; private final StatisticAudit audit;
    ...
    public PlayerStatistic(final PlayerId playerId, final StatisticId statisticId, final StatisticScope scope,
        ...
        this.playerId = Objects.requireNonNull(playerId, "playerId"); this.statisticId = Objects.requireNonNull(statisticId, "statisticId"); this.scope = Objects.requireNonNull(scope, "scope");
        if (value < 0) { throw new IllegalArgumentException("value must be non-negative"); }
        this.value = value; this.revision = Objects.requireNonNull(revision, "revision"); this.audit = Objects.requireNonNull(audit, "audit");
    }
